...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      ...
      <a href="relasi.php" class="btn btn-sm btn-primary pull-right"><i class="fa fa-arrow-left"></i> KEMBALI</a>
    </div>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="relasi_update.php" method="post" class="form-inline">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped" border="1" style="width: 100%;">                    
                <tr>                    
                  ...
                  <?php               
                  $id_k=$_GET['penyakit'];
                  $penyakit = mysqli_query($koneksi, "select * from penyakit where alt_id='$id_k'");   
                  $ker=mysqli_fetch_assoc($penyakit);
                  $a=$ker['alt_id'];
                  ?>
                ...
                while($ge=mysqli_fetch_array($g)){
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="hidden" name="penyakit" value="<?php echo $id_k; ?>">
                      ...
                      <select name="nilai[]" class="form-control" style="width: 150px" required="required">
                        <option value=""></option>
                        <?php 
                        $x = mysqli_query($koneksi, "select * from relasi where kec_penyakit='$a' and kec_gejala='$b'");
