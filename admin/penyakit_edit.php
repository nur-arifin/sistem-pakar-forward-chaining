...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      <a href="penyakit.php" class="btn btn-sm btn-primary pull-right"><i class="fa fa-arrow-left"></i> KEMBALI</a>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <form action="penyakit_update.php" method="post">
            <?php
            $id = $_GET['id'];
            $data = mysqli_query($koneksi, "select * from penyakit where alt_id='$id'");   
